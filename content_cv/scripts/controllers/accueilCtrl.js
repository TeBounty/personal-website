...
angular.module('CvShow').controller("accueilCtrl", function ($scope) {
    ...
    $scope.contentRechercher = "Je suis à la recherche d'une alternance Développement Logiciel au sein d'une entreprise qui pourra m'accompagner dans mon évolution.";
